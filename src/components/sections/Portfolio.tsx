...
const projects = [
  {
    id: 1,
    title: 'Скульптура "Спираль"',
    image: '/images/portfolio/1.jpg',
    category: 'Городской парк',
  },
  {
    id: 2,
    title: 'Композиция "Мама и дети"',
    image: '/images/portfolio/2.jpg',
    category: 'Жилой комплекс',
  },
  {
    id: 3,
    title: 'Арт-объект "Лесная пара"',
    image: '/images/portfolio/3.jpg',
    category: 'Бизнес-центр',
  },
  {
    id: 4,
    title: 'Скульптура "<Бесконечность>"',
    image: '/images/portfolio/4.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 5,
    title: 'Скульптура "Защитник"',
    image: '/images/portfolio/5.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 6,
    title: 'Скульптура "Материнство"',
    image: '/images/portfolio/6.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 7,
    title: 'Скульптура "Ветвь мира"',
    image: '/images/portfolio/7.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 8,
    title: 'Скульптура "Семья"',
    image: '/images/portfolio/p8.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 9,
    title: 'Скульптура "Волейболист"',
    image: '/images/portfolio/p9.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 10,
    title: 'Скульптура "Промышленность"',
    image: '/images/portfolio/p10.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 11,
    title: 'Скульптура "Кристал"',
    image: '/images/portfolio/p11.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 12,
    title: 'Скульптура "Хирург"',
    image: '/images/portfolio/p12.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 13,
    title: 'Скульптура "Здесь и сейчас"',
    image: '/images/portfolio/p13.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 14,
    title: 'Скульптура "В поисках моря"',
    image: '/images/portfolio/p14.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 15,
    title: 'Скульптура "Учитель"',
    image: '/images/portfolio/p15.jpg',
    category: 'Загородный клуб',
  },
  {
    id: 16,
    title: 'Скульптура "Вечный огонь"',
