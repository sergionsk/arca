...
const portfolioData: Category[] = [
  ...
  },
  {
    ...
    images: [
      { id: 9, src: '/images/portfolio/1.jpg', title: 'Памятник основателям города', description: 'Сквер у администрации, 2022' },
      { id: 10, src: '/images/portfolio/2.jpg', title: 'Скульптура "Мудрая сова"', description: 'Детский парк, 2023' },
      { id: 11, src: '/images/portfolio/3.jpg', title: 'Композиция "Семья"', description: 'Коттеджный посёлок, 2024' },
      { id: 12, src: '/images/portfolio/5.jpg', title: 'Бюст деятеля культуры', description: 'Театральная площадь, 2023' },
      { id: 13, src: '/images/portfolio/7.jpg', title: 'Бюст деятеля культуры', description: 'Театральная площадь, 2023' },
      { id: 14, src: '/images/portfolio/p12.jpg', title: 'Бюст деятеля культуры', description: 'Театральная площадь, 2023' },
      { id: 15, src: '/images/portfolio/p14.jpg', title: 'Бюст деятеля культуры', description: 'Театральная площадь, 2023' },
      { id: 16, src: '/images/portfolio/p15.jpg', title: 'Бюст деятеля культуры', description: 'Театральная площадь, 2023' },
    ],
  },
  {
    id: 'panels',
    ...
    images: [
      { id: 17, src: '/images/portfolio/panno/Ангел.jpg', title: 'Панно "Ангел"', description: 'Холл бизнес-центра, 2024' },
      { id: 18, src: '/images/portfolio/panno/Любовь.jpg', title: 'Модульная композиция "Любовь"', description: 'Ресторан, 2023' },
      { id: 18, src: '/images/portfolio/panno/Любовь2.jpg', title: 'Модульная композиция "Любовь"', description: 'Ресторан, 2023' },
      { id: 19, src: '/images/portfolio/panno/Оазис.jpg', title: 'Панно "Оазис"', description: 'СПА-центр, 2024' },
      { id: 19, src: '/images/portfolio/panno/Оазис2.jpg', title: 'Панно "Оазис"', description: 'СПА-центр, 2024' },
      { id: 20, src: '/images/portfolio/panno/Преодолевая трудности.jpg', title: 'Фасадное панно', description: 'Торговый центр, 2023' },
      { id: 20, src: '/images/portfolio/panno/Свобода.jpg', title: 'Панно "Свобода"', description: 'Торговый центр, 2023' },
      { id: 20, src: '/images/portfolio/panno/Сила.jpg', title: 'Панно "Сила"', description: 'Торговый центр, 2023' },
    ],
  },
];
